 ...
 * Originally written by: Mas Dhani
 * Website: Situs Informasi Internet (http://www.royalrawsurabaya.blogspot.com)
 * On 24th August 2009
 *
...
function hn_writeContent(){
    var s = "<div id='hn_headline' title='HEADLINE NEWS FROM "+hn_getBlogTitle()+"'>";
    s += "<div style='float:left'>";
    s += " <a href='"+hn_feed_url+"'>";
    s += "  <img src='http://sites.google.com/site/masdhanisite/CoffeeCup_Feed_128x128.png'";
    s += " height='20'/>";
    s += " </a>";
    s += "</div>";
    if(hn_tampilkan_judul){
        s += "  <div style='float:left; font-size:8px; text-align:right; margin-left:10px;'>";
        s += "    HEADLINE NEWS FROM <br/>";
    ...
    if(hn_backlink == true | hn_backlink == undefined){
        ...
        s += "  Widget by <br/>";
        s += "  <a href='http://www.royalrawsurabaya.blogspot.com'>";
        s += "    Far";
        s += "  </a>";
        s += "</div>";
    }
